...
export default function WorkersHeader({ onAddWorker, onClearFilters }: WorkersHeaderProps) {
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-2xl font-semibold">Pracownicy</h1>
        <p className="text-gray-600">Lista wszystkich pracowników. Wyświetlaj, dodawaj, edytuj i usuwaj pracowników.</p>
      </div>
